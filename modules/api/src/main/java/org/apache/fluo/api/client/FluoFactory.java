...
public class FluoFactory {
   ...
   * {@link FluoConfiguration}) should contain all Fluo configuration properties.
   * Review all properties but many have a default. At a minimum, configuration should contain the
   * following properties that have no default: fluo.connection.application.name,
   * fluo.accumulo.user, fluo.accumulo.password, fluo.accumulo.instance, fluo.accumulo.table,
   * fluo.accumulo.classpath
   */
