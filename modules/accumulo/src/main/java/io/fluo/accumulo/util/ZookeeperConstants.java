...
public class ZookeeperConstants {
  ...
  public static final String yarnTwillIdPath(String zkPath) {
	return zkPath + YARN_TWILL_ID;  
  }
  
  public static final String yarnAppIdPath(String zkPath) {
    return zkPath + YARN_APP_ID;
  }
}
