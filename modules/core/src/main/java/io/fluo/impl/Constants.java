...
public class Constants {
  ...
  public static class Zookeeper {
    ...
    public static final String FLUO_INSTANCE_ID = CONFIG + "/io.fluo.instance.id";
    public static final String OBSERVERS = CONFIG + "/io.fluo.observers";
    public static final String WORKER_CONFIG = CONFIG + "/io.fluo.workers";
  ...
  public static final String WORKER_THREADS = "io.fluo.config.worker.numThreads";
