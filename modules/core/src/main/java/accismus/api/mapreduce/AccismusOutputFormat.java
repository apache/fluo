...
public class AccismusOutputFormat extends OutputFormat<Loader,NullWritable> {
  ...
  private static String PROPS_CONF_KEY = AccismusOutputFormat.class.getName() + ".props";
  ...
  /**
   * Call this method to initialize the Accismus connection props and {@link LoaderExecutor} props
   * 
   * @param conf
   * @param props
