...
/**
 * This class wraps the {@link AccumuloFileOutputFormat} and converts to Accismus's data format. You can use the static methods on
 * {@link AccumuloFileOutputFormat} to configure the output file.
 * 
 * The intended use of this output format is for seeding an initialized Accismus table on which no transactions have executed.
 * 
...
public class AccismusFileOutputFormat extends FileOutputFormat<RowColumn,ByteSequence> {
