...
ADMIN_OPTS="-fluo-home $FLUO_HOME -hadoop-prefix $HADOOP_PREFIX -application FluoWorker"

case "$1" in
start)
  java -cp "$FLUO_HOME/lib/*:$FLUO_HOME/lib/observers/*" io.fluo.cluster.ClusterAdmin $ADMIN_OPTS -command start
	;;
stop)
