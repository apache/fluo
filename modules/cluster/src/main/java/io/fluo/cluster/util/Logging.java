...
public class Logging {
  ...
  public static void init(String application, String configDir, String logOutput) throws IOException {
    ...
    if (logOutput.equalsIgnoreCase("STDOUT")) {
      ...
      System.setProperty("io.fluo.log.application", application);
      System.setProperty("io.fluo.log.dir.log", logOutput);

      String localhost = InetAddress.getLocalHost().getHostName();
      System.setProperty("io.fluo.log.ip.localhost.hostname", localhost);
