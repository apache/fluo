...
public class InitializationProperties extends WorkerProperties {
  ...
  public static final String CLEAR_ZOOKEEPER_PROP = "accismus.init.zookeeper.clear";
  public static final String TABLE_PROP = "accismus.init.accumulo.table";
  public static final String CLASSPATH_PROP = "accismus.init.accumulo.classpath";
